...
export const reclaimedCounter = new Proxy(
  {} as ReturnType<ReturnType<typeof metrics.getMeter>['createCounter']>,
  {
    get:
      (_, prop) =>
      (...args: unknown[]) =>
        (_reclaimedCounter as unknown as Record<string, (...a: unknown[]) => unknown>)[
          prop as string
        ]?.(...args),
  }
);
export const alreadyTakenCounter = new Proxy(
  {} as ReturnType<ReturnType<typeof metrics.getMeter>['createCounter']>,
  {
    get:
      (_, prop) =>
      (...args: unknown[]) =>
        (_alreadyTakenCounter as unknown as Record<string, (...a: unknown[]) => unknown>)[
          prop as string
        ]?.(...args),
  }
);
export const reclaimErrorCounter = new Proxy(
  {} as ReturnType<ReturnType<typeof metrics.getMeter>['createCounter']>,
  {
    get:
      (_, prop) =>
      (...args: unknown[]) =>
        (_reclaimErrorCounter as unknown as Record<string, (...a: unknown[]) => unknown>)[
          prop as string
        ]?.(...args),
  }
);
