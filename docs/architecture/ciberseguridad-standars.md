...
| HIGH | Configuración de secretos | Secreto interno/admin unificado en INTERNAL_SECRET entre compose, API, workers y guard; drift prevenido por tests/config fail-closed. | Cierre F1 | OWASP ASVS §2, NIST IA-5 |
