...
| `scripts/validate-contract-roundtrip.ts` | Script | TS-side schema validation smoke | Contract validation | active |
| `.github/workflows/contracts.yml` | CI | Generate + drift check + Python contract tests | CI enforcement | active |
