...
export const ExecutionSchema = z.object({
  ...
  budgetSnapshotJson: z.record(z.string(), z.unknown()).nullable().optional(),
  contextSnapshotJson: z.record(z.string(), z.unknown()).nullable().optional(),
  createdBy: z.string(),
...
export const ExecutionStepSchema = z.object({
  ...
  inputJson: z.record(z.string(), z.unknown()).nullable().optional(),
  outputJson: z.record(z.string(), z.unknown()).nullable().optional(),
  errorCode: z.string().nullable().optional(),
  errorMessage: z.string().nullable().optional(),
